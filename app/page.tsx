...
export default function Home() {
  return (
    <main className="space-y-20 my-8 mt-20">
      {/* Section 1 */}
      <section className="container mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between">
      ...
      {/* Section 2 */}
      <section className="w-full bg-foreground py-8 md:py-16">
        <div className="container mx-auto px-4 md:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
          {[
      ...
      {/* Section 3 */}
      <section id="app" className="container mx-auto px-4 md:px-8 relative">
      ...
      {/* Section 4 */}
      <section id="tutorial" className="container mx-auto px-4 md:px-8">
      ...
      {/* Section 5 */}
      <section id="about" className="w-full bg-yellow py-8 md:py-16">
